...
- `dist/unread2calendar-thunderbird-3.0.2.xpi`
- Release direct download (after publishing):
  - `https://github.com/Liao-MH/unread2calendar/releases/download/v3.0.2/unread2calendar-thunderbird-3.0.2.xpi`
...
## Version & Updates
- This README targets add-on version: `v3.0.2`
