...
- `dist/unread2calendar-thunderbird-2.0.15.xpi`
- Release direct download (after publishing):
  - `https://github.com/Liao-MH/unread2calendar/releases/download/v2.0.15/unread2calendar-thunderbird-2.0.15.xpi`
...
## Version & Updates
- This README targets add-on version: `v2.0.15`
